...
import { createChat, exposeDepsJs, getPlugin, openChat, openChatToSide } from './test-utils';

const CHAT = 'test.chat';

test.describe('#inputToolbar', () => {
  test('Should remove toolbar item for main area chat', async ({ page, tmpPath }) => {
    ...
    const inputToolbar = chatPanel.locator('.jp-chat-input-container .jp-chat-input-toolbar');
    ...
    const inputToolbarSide = chatSidePanel.locator('.jp-chat-input-container .jp-chat-input-toolbar');
